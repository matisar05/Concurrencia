...
public class Ej18 extends java.lang.Object {
    { JRinit(); }
    ...
    private static boolean hayProducto = false;
    ...
    {
        public ProcOp_voidTovoid_implproductor(Ej18 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                Ej18.productorvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Ej18.productorvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    private static void productorvoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop2: while (true) {
                    JRLoop0: while (hayProducto) {
                    }
                    JRLoop1: while (testAndSet()) {
                    }
                    if (!hayProducto) {
                        // Begin Expr2
                        contador++;
    ...
    {
        public ProcOp_voidTovoid_implconsumidor(Ej18 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Ej18.consumidorvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Ej18.consumidorvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private static void consumidorvoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop5: while (true) {
                    JRLoop3: while (!hayProducto) {
                    }
                    JRLoop4: while (testAndSet()) {
                    }
                    if (hayProducto) {
                        // Begin Expr2
    ...
    protected JREj18 jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JREj18(op_consumidor_voidTovoid, op_productor_voidTovoid);
    	this.JRcalled = true;
    }
